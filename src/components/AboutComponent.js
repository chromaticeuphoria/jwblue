      ...
      <div className="container">
        ...
        <div className="neoh_fn_about_item">
          <div className="img_item">
            <Image src="/img/hero/bluelabel1000.png" alt="Johnnie Walker Blue Label" width={1000} height={1000} />
          </div>
        ...
        <div className="neoh_fn_about_item reverse">
          <div className="img_item">
            <Image src="/img/hero/productjw.png" alt="Johnnie Walker Product" width={1000} height={1000} />
          </div>
          <div className="content_item">
            <div className="neoh_fn_title" data-align="left">
        ...
        <div className="neoh_fn_about_item">
          <div className="img_item">
            <Image src="/img/hero/sustain2.png" alt="Johnnie Walker Sustainable Future" width={1000} height={1000} />
          </div>
          <div className="content_item">
            <div className="neoh_fn_title" data-align="left">
